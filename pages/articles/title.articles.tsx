...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Ion Mocanu</title>
            <meta name="description" content="Explore articles authored by Ion Mocanu, a Full Stack Engineer and Developer." />
