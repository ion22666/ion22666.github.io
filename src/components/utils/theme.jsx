        ...
        if (canvasEle) {
            ...
            class MiniGl {
                constructor(e, n, t, i = !1) {
                    ...
                    (s.canvas = e), (s.gl = s.canvas.getContext('webgl', { antialias: !0 })), (s.meshes = []);
                    const r = s.gl;
                                ...
                                value: class {
                                    constructor(e, n, t = {}) {
                                        function i(e, n) {
                                            ...
                                            return r.shaderSource(t, n), r.compileShader(t), r.getShaderParameter(t, r.COMPILE_STATUS) || console.error(r.getShaderInfoLog(t)), s.debug('Material.compileShaderSource', { source: n }), t;
                                        }
                                        function o(e, n) {
                                        ...
                                        (a.vertexSource = `\n              ${l}\n              attribute vec4 position;\n              attribute vec2 uv;\n              attribute vec2 uvNorm;\n              ${o(s.commonUniforms, 'vertex')}\n              ${o(
                                            ...
                                            r.getProgramParameter(a.program, r.LINK_STATUS) || console.error(r.getProgramInfoLog(a.program)),
                                    ...
                                    attachUniforms(e, n) {
                                        ...
                                        void 0 === e
                                            ...
                                            : 'struct' == n.type
                                            ? Object.entries(n.value).forEach(([n, i]) => t.attachUniforms(`${e}.${n}`, i))
                                    ...
                                    setSize(e = 1, n = 1, t = 'xz') {
                                        ...
                                        for (let e = 0; e <= i.ySegCount; e++) {
                                            ...
                                            for (let s = 0; s <= i.xSegCount; s++) {
                                                const r = o + s * a,
                                                    l = e * (i.xSegCount + 1) + s;
                                                (i.attributes.position.values[3 * l + 'xyz'.indexOf(t[0])] = r), (i.attributes.position.values[3 * l + 'xyz'.indexOf(t[1])] = -n);
                                            }
                                        }
                ...
                setSize(e = 640, n = 480) {
                    (this.width = e), (this.height = n), (this.canvas.width = e), (this.canvas.height = n), this.gl.viewport(0, 0, e, n), (this.commonUniforms.resolution.value = [e, n]), (this.commonUniforms.aspectRatio.value = e / n), this.debug('MiniGL.setSize', { width: e, height: n });
                }
                setOrthographicCamera(e = 0, n = 0, t = 0, i = -2e3, s = 2e3) {
                    (this.commonUniforms.projectionMatrix.value = [2 / this.width, 0, 0, 0, 0, 2 / this.height, 0, 0, 0, 0, 2 / (i - s), 0, e, n, t, 1]), this.debug('setOrthographicCamera', this.commonUniforms.projectionMatrix.value);
                }
                render() {
            ...
            class Gradient {
                ...
                disconnect() {
                    this.scrollObserver &&
                        (window.removeEventListener('scroll', this.handleScroll), window.removeEventListener('mousedown', this.handleMouseDown), window.removeEventListener('mouseup', this.handleMouseUp), window.removeEventListener('keydown', this.handleKeyDown), this.scrollObserver.disconnect()),
