            ...
            <Container spacing={['verticalXXXLrg']}>
                <section className={`${signin.content} ${signin.container}`}>
                    <div className={signin.copy}>
                        <div className={signin.container} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <form style={{ margin: '0 auto', maxWidth: '300px' }} onSubmit={handleFormSubmit} method="POST">
                                {/* Email input */}
